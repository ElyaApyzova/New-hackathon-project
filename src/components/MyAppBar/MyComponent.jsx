...
const MyComponent = () => {
  return (
    ...
    <Typography variant="h1" component='div' textAlign='center'  sx={{ fontSize: '40px', fontWeight: "600", color: '#2E2E2E', marginTop: '150px', marginBottom: '70px' }}>Какое дерево может стать семейным?</Typography>
